...
const commandMappings: CommandMapping[] = [
  ...
  {
    npmCommand: 'help-search',
    pnpmCommand: 'help-search',
    type: 'npm-passthrough',
    requiresSecurityFlags: false,
  },
  ...
  // Compound commands
  {
    npmCommand: 'install-test',
    pnpmCommand: '',
    type: 'custom',
    aliases: ['it'],
  },
  {
    npmCommand: 'install-ci-test',
    pnpmCommand: '',
    type: 'custom',
    aliases: ['cit'],
  },
